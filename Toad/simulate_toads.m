function[X] = simulate_toads(theta, ntoads, ndays, model,d0)
...
%         3 random return but distance dependent
% OUTPUT:
...
else % model 3 (simulation of this model may be slow due to inability to vectorise the code)
    for j = 1:ntoads
        if model == 3
